...
HD_PWD='D:/Test/final_project/final_project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log multi_conv_comb.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source multi_conv_comb.tcl
